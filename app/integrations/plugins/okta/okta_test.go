...
func TestOktaCapabilities(t *testing.T) {
	caps := integrationplugins.CapabilitiesFor("okta")
	if len(caps) != 3 {
	...
	tests := []struct {
		...
		{"create_user", "/api/v1/users", "POST"},
		{"update_user", "/api/v1/users/*", "PUT"},
		{"deactivate_user", "/api/v1/users/*/lifecycle/deactivate", "POST"},
	}
