...
func TestHistogramWriteProm(t *testing.T) {
	...
	h.writeProm(rr, "authtranslator_upstream_response_headers_duration_seconds", "foo")
	...
	if !strings.HasPrefix(lines[8], "authtranslator_upstream_response_headers_duration_seconds_sum{integration=\"foo\"}") {
